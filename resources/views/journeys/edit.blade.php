...
@section('content')
    ...
    <main class="mx-auto mt-10 px-4 md:mt-16 mb-10">
        ...
        <form action="{{ route('journeys.update', ['journey' => $journey]) }}" method="post" id="form-journey" class="md:w-1/2 md:mx-auto">
            @csrf
            @method('put')
            ...
            <fieldset> <!-- Start Other Information Fieldset -->
                ...
                <div class="mt-4 flex items-center">
                    ...
                    <input type="hidden" name="allows_pets" value="0">
                ...
                <div class="mt-4 flex items-center">
                    ...
                    <input type="hidden" name="allows_smoking" value="0">
