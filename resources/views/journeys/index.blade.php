...
@section('content')
    <div>
        <div class="h-full">
            <div class="parallax ninety flex justify-center items-center">
        ...
        <main class="mx-auto mt-10 px-4">
            ...
            <div class="text-center mb-10">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mb-4 flex-wrap justify-between items-center md:flex-row md:w-4/5 md:mx-auto md:justify-center md:items-center">
                        ...
                        <p class="flex mt-6 w-full md:flex-col md:items-center md:justify-center md:w-1/2">
                            ...
                            <span class="text-grey-darker flex-1 text-left md:text-center md:text-xl md:leading-normal">Planifiez vos départs avec les conducteurs</span>
                        </p>
                    ...
                    <a class="italic text-center text-blue mt-6 block no-underline md:mt-10 md:text-lg md:w-1/2 md:p-5 md:mx-auto"
                       href="{{ route('faq') }}">Lire notre FAQ</a>
                </div>
            </div>
        </main>
        <div class="parallax forty-five flex items-center justify-center">
            <div class="w-full md:w-1/2 md:mx-auto px-4">
                @Auth
                    <a href="{{ route('journeys.create') }}" class="button mt-4 md:w-1/2 md:mx-auto">Proposer un nouveau trajet</a>
                @else
                    <div class="block md:flex md:-px-4">
                        <a href="{{ route('inscription') }}" class="button md:flex-1 md:mx-4">M'inscrire</a>
                        <a href="{{ route('connection') }}" class="button mt-4 md:flex-1 md:mt-0 md:mx-4">Me connecter</a>
                    </div>
                @endauth
